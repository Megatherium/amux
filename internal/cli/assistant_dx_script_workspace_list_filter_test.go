...
func TestAssistantDXWorkspaceList_WorkspaceFilterShowsWorkspaceLabel(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXWorkspaceList_AllBypassesContextProjectFilter(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceList_AllConflictsWithProject(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
