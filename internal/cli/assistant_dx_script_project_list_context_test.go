...
func TestAssistantDXProjectList_SuggestsContextProjectPath(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXProjectList_ContextPayloadCompactsLineageByDefault(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
