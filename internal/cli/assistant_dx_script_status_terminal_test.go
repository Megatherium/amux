...
func TestAssistantDXGitShip_NoChangesWithPushPushesAheadCommits(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXWorkspaceDecide_RecommendsNestedFromParent(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceDecide_ProjectOnlyDoesNotRequireAlternateCommand(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXTerminalPreset_StartsNextJSPreset(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXStatus_SurfacesCompletedAlertAndReviewActions(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXStatus_InvalidResultCommandEnvFallsBackToStatus(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
`)
	...
	env := os.Environ()
	env = withEnv(env, "PATH", fakeBinDir+":"+os.Getenv("PATH"))
	env = withEnv(env, "AMUX_ASSISTANT_DX_STATUS_RESULT_COMMAND", "status;rm -rf /")
