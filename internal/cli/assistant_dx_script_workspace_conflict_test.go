...
func TestAssistantDXProjectAdd_PropagatesStructuredAmuxError(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXProjectAdd_InitialCommitGuidanceForWorkspaceCreate(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceCreate_RecoversFromExistingBranchConflict(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceCreate_ConflictRecoveryPrefersExactNameMatch(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceCreate_ConflictWithoutMatchSuggestsNewName(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
