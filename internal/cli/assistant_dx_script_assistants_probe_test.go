...
func TestAssistantDXAssistants_ProbeWorkspaceNotFoundReturnsCommandError(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXAssistants_ProbePrefersProbePassedAssistant(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
