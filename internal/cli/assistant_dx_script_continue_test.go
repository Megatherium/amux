...
func TestAssistantDXStatus_SurfacesNeedsInputAndStaleSessions(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXStatus_DefaultOmitsStaleSessionAlerts(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXContinue_ResolvesWorkspaceAgentAndCallsTurnScript(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXContinue_PassthroughSanitizesNeedsInputAndAddsFallbackCommand(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXContinue_AutoFollowsUpNeedsInputOnce(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXContinue_AutoStartsWhenNoActiveAgent(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXContinue_NoTargetUsesSingleActiveAgent(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
