...
func TestAssistantDXProjectList_PaginatesAndAddsNavigationActions(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXProjectList_QuickActionCallbackDataIsAssistantSafe(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXProjectList_DataIncludesContextSnapshot(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceList_UsesContextProjectWhenProjectMissing(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
