...
func TestAssistantDXContinue_WorkspaceNotFoundReturnsCommandError(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXContinue_InvalidAssistantReturnsCommandError(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXContinue_WorkspaceValidationPrecedesAssistantValidation(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXContinue_AssistantWithoutAutoStartReturnsCommandError(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
