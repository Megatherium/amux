...
func TestAssistantDXStart_CommandErrorFallbackUsesWorkspaceStatus(t *testing.T) {
	requireBinary(t, "jq")
...
`)
	...
	env = withEnv(env, "AMUX_ASSISTANT_DX_START_STEP_FALLBACK", "false")
...
func TestAssistantDXStart_FallsBackToStepRunOnTurnCommandFailure(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXStart_RetriesWithFallbackAssistantOnCommandFailure(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
`)
	...
	env = withEnv(env, "AMUX_ASSISTANT_DX_TURN_SCRIPT", fakeTurnPath)
	env = withEnv(env, "AMUX_ASSISTANT_DX_START_STEP_FALLBACK", "false")
	env = withEnv(env, "AMUX_ASSISTANT_DX_START_COMMAND_ERROR_FALLBACK_ASSISTANT", "gemini")
...
func TestAssistantDXStart_PrunesStaleSessionsAndRetriesOnCommandFailure(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
`)
	...
	env = withEnv(env, "AMUX_ASSISTANT_DX_TURN_SCRIPT", fakeTurnPath)
	env = withEnv(env, "AMUX_ASSISTANT_DX_START_STEP_FALLBACK", "false")
	env = withEnv(env, "AMUX_ASSISTANT_DX_START_COMMAND_ERROR_FALLBACK_ASSISTANT", "")
	env = withEnv(env, "AMUX_ASSISTANT_DX_START_COMMAND_ERROR_RETRY", "false")
...
func TestAssistantDXStart_RetriesTransientAmuxCommandFailureOnce(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
