...
func TestAssistantDXWorkspaceCreate_NestedFromWorkspace(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXWorkspaceCreate_FromWorkspaceAcceptsCanonicalProjectPathAlias(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceCreate_ProjectNotRegisteredAutoRecoversFromWorkspaceRepo(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceList_ErrorsWhenWorkspaceFilterMissing(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXProjectPick_DisambiguationUsesIndexSelectors(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXProjectPick_AutoSelectsCanonicalPathAliases(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXProjectPick_PrefersActiveContextProjectWhenAmbiguous(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
