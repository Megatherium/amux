...
func TestAssistantDXGitShip_NoChangesButAheadSuggestsPush(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXGitShip_PushWithoutOriginSuggestsRemoteInspection(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
	requireBinary(t, "git")
