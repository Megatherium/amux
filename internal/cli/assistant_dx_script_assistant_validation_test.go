...
func TestAssistantDXStart_InvalidAssistantReturnsCommandError(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXReview_InvalidAssistantReturnsCommandError(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkflowKickoff_InvalidAssistantReturnsCommandError(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkflowDual_InvalidAssistantReturnsCommandError(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXStart_UnlistedAssistantPassesThrough(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
