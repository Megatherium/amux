...
func TestAssistantDXScriptDoesNotUseBash4AssociativeArrays(t *testing.T) {
	...
	if strings.Contains(string(body), "declare -A") {
		t.Fatalf("assistant-dx.sh should avoid Bash 4 associative arrays for macOS Bash 3 compatibility")
	}
}

func TestAssistantDXProjectAdd_CreatesWorkspace(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXProjectAdd_WorkspaceConflictRecoversExistingWorkspace(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXProjectAdd_WorkspaceConflictWithoutExistingWorkspaceSuggestsNewName(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXProjectAdd_WorkspaceConflictAutoRetriesWithAlternateName(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXProjectAdd_InferPathFromGitRoot(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
	requireBinary(t, "git")

	scriptPath, err := filepath.Abs(filepath.Join("..", "..", "skills", "amux", "scripts", "assistant-dx.sh"))
	if err != nil {
...
func TestAssistantDXProjectList_QueryFiltersProjects(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
