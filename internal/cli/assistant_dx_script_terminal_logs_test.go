...
func TestAssistantDXTerminalLogs_DetectsNgrokAuthLimit(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXTerminalLogs_DetectsMissingPackageManifest(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXTerminalLogs_DetectsPortInUse(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXTerminalLogs_DetectsLocalServerUnreachable(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
