...
func TestAssistantDXCommandError_DefaultsToGuideSuggestion(t *testing.T) {
	requireBinary(t, "jq")
...
`)
	...
	if !strings.Contains(suggested, "assistant-dx.sh guide") {
...
func TestAssistantDXCommandError_UsesWorkspaceStatusWhenContextExists(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXAmuxError_TerminalCommandSuggestsWorkspaceLogs(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXAmuxError_TerminalSessionCreateSuggestsInitCommand(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXParseError_MissingFlagValueReturnsCommandErrorJSON(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXStart_AllowsDashPrefixedPromptValue(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
	...
	fakeBinDir := t.TempDir()
	fakeAmuxPath := filepath.Join(fakeBinDir, "amux")
	fakeTurnPath := filepath.Join(fakeBinDir, "assistant-turn.sh")
...
func TestAssistantDXContinue_AutoStartAllowsDashPrefixedTextValue(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceDecide_AllowsDashPrefixedTaskValue(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
