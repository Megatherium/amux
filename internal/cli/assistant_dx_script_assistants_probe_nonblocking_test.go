...
func TestAssistantDXAssistants_ProbeNeedsInputIsNonBlockingWhenPassedAssistantsExist(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXAssistants_ProbeMixedFailedAndNeedsInputIsAttention(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
