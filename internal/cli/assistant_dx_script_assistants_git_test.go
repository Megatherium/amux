...
func TestAssistantDXAssistants_ReportsMissingFromConfig(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXAssistants_ProbeAggregatesReadiness(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXAssistants_ProbePrioritizesCodexUnderLimit(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXGitShip_CommitsWorkspaceChanges(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
	requireBinary(t, "git")
