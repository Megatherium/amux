...
func TestAssistantDXWorkspaceCreate_NestedPersistsScopeLineage(t *testing.T) {
	requireBinary(t, "jq")
...
func TestAssistantDXWorkspaceList_AnnotatesWorkspaceTypes(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceList_NameInferenceWithoutParentDefaultsToProject(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXStart_EmitsWorkspaceContextWithType(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXStart_DoesNotPersistNameInferredWorkspaceLineage(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
...
func TestAssistantDXWorkspaceCreateConflict_DoesNotOverwriteExistingLineageScope(t *testing.T) {
	requireBinary(t, "jq")
	requireBinary(t, "bash")
