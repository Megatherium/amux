...
var prefixCommandTable = []prefixCommand{
	...
	{Sequence: []string{"t", "b"}, Desc: "new agent with ticket", Action: "new_ticket_agent_tab"},
	{Sequence: []string{"t", "a"}, Desc: "new agent tab", Action: "new_agent_tab"},
	{Sequence: []string{"t", "t"}, Desc: "new tab", Action: "new_terminal_tab"},
