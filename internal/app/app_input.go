...
func (a *App) update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case messages.ShowSelectTicketDialog:
		if cmd := a.ui.ShowSelectTicketDialog(a.ticketServices, a.activeWorkspace, a.activeProject); cmd != nil {
			cmds = append(cmds, cmd)
		}
	...
	case messages.ShowSettingsDialog:
		a.ui.ShowSettingsDialog(a.version, a.updateAvailable, a.updateService)
