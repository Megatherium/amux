...
**YOU ARE IN: `badmux/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/badmux/` (rig root) or other directories
...
**Your mail address:** `badmux/polecats/rust`
**Your rig:** badmux
**Your Witness:** `badmux/witness`
...
| Ask Witness for help | `gt mail send badmux/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`badmux/witness`) when:
...
```bash
gt mail send badmux/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
